          ...
          {currentPage === 'home' && (
            ...
            >
              <div className="w-full flex flex-col items-center scale-[0.95] md:scale-100 origin-center mt-0 md:mt-0 py-4 md:py-0">
                <div id="header-section" className={`z-10 text-center mb-6 md:mb-8 flex flex-col items-center pt-2 md:pt-0 overflow-visible transition-all duration-500 ${info ? 'mt-10 md:mt-0' : '-mt-20 md:mt-0'}`}>
