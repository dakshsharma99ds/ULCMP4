...
const About = () => {
  ...
  const socialPlatforms = [
    { name: "TIKTOK", path: "M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.17-2.86-.6-4.12-1.31a6.447 6.447 0 0 1-1.87-1.51v7.36c.03 1.88-.51 3.82-1.72 5.27a6.65 6.65 0 0 1-5.26 2.62c-2.32.1-4.69-.92-6.07-2.81-1.39-1.89-1.6-4.52-.55-6.57 1.01-2.04 3.14-3.52 5.41-3.66.12 0 .24 0 .36.01v4.03a2.43 2.43 0 0 0-1.8.84c-.65.79-.8 1.94-.39 2.88.39.99 1.41 1.69 2.48 1.69a2.535 2.535 0 0 0 2.52-2.52V0l.05.02z" },
  ...
  return (
    <div className="z-10 w-full max-w-4xl flex flex-col items-center select-none scale-105 md:scale-100 origin-top pt-0 md:pt-0 -mt-12 md:mt-0">
      <div className="flex flex-col items-center w-full mb-6 md:mb-10">
        <h1 className="nico-font text-5xl md:text-8xl tracking-widest text-white drop-shadow-[0_0_20px_rgba(52,211,153,0.3)] select-text">
          ABOUT
        </h1>
        <p className="text-emerald-500/60 text-[8px] md:text-[10px] tracking-[0.45em] md:tracking-[1.00em] mt-2 uppercase text-center w-full whitespace-nowrap select-text">
